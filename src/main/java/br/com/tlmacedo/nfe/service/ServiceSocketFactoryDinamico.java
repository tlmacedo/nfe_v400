...
public class ServiceSocketFactoryDinamico implements ProtocolSocketFactory {
    ...
    public ServiceSocketFactoryDinamico(X509Certificate certificate,
    ...
    private SSLContext createSSLContext() {
        try {
            ...
            return sslContext;
        } catch (KeyManagementException | IOException | CertificateException | NoSuchAlgorithmException | KeyStoreException ex) {
            error(ex.toString());
        }
        return null;
